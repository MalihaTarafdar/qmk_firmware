...
#define RGB_MATRIX_KEYPRESSES // Enables keypress-triggered effects
#define RGB_MATRIX_FRAMEBUFFER_EFFECTS // Enables framebuffer animations
...
#define ENABLE_RGB_MATRIX_ELECTRONS_WRAP
